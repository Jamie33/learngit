...
$_LANG['os'][OS_ONLY_REFOUND] = 'REFOUND';
$_LANG['os'][OS_RETURNED_PART] = '部分已退货';
$_LANG['os'][OS_RETURNED_PART] = 'RETURNED_PART';
...
$_LANG['ss'][SS_SHIPPED_ING] = 'SHIPPEDING'; // 已分单
